...
import ImageApprovalMenuItem from "./MenuItem/UserLayoutsApproval";

const { Sider, Content } = Layout;

const UserLayoutsApproval = ({ children }: any) => {
...
export default UserLayoutsApproval;
